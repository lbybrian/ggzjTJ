...
// import BaseMap from '../../static/example/mapHeatMap/baseMap.js';
// import utils from '../../static/example/mapHeatMap/mapUtils.js';
...
export default {
  ...
  mounted () {
    this.$nextTick(function () {
      this.init();
      // this.updateData(this.map,this.hotData)
