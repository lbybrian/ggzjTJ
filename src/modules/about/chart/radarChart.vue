...
<script>
import Example1 from "../../../../static/example/radarChart/1.vue";
...
export default {
  ...
  data() {
    return {
      basicData: {},
      componentPath: "/static/example/radarChart/1.vue",
      exampleSelect: "",
      activeNames: "1",
      exampleCodeDialog: {
        visible: false,
        ...
        data: [
          {
            name: "itemStyle",
            description:
              "雷达图的样式和属性。请参考https://echarts.apache.org/zh/option.html#series-line",
            type: "Object",
            option: "-",
            default: "-",
          },
