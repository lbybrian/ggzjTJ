...
<script>
import Example1 from "../../../../static/example/customChart/1.vue";
...
export default {
  ...
  data() {
    return {
      basicData: {},
      componentPath: "/static/example/customChart/1.vue",
      exampleSelect: "",
      activeNames: "1",
      exampleCodeDialog: {
        visible: false,
      ...
      paramDescription: {
        ...
        data: [{
          name: "itemStyle",
          description: "折线的样式和属性。请参考https://echarts.apache.org/zh/option.html#series-line",
          type: "Object",
          option: "-",
          default: "-",
        },
          ...
          {
            name: "titleStyle",
            description: "标题字符串样式和属性。请参考https://echarts.apache.org/zh/option.html#textStyle",
            type: "Object",
            option: "-",
            default: "-",
          },
          {
            name: "tooltip",
            description: "设浮层提示信息相关样式和属性。请参考https://echarts.apache.org/zh/option.html#tooltip",
            type: "Object",
            option: "-",
            default: "-",
          }
  ...
  methods: {
    ...
    exampleCallback1() {
      ...
      tData.title = "武器装备战损趋势";
      tData.name = ["手榴弹战损", "MG5冲锋枪战损", "坦克战损"];
      tData.data = [{
        name: "周一",
        value: [3000, 200, 2],
      },
