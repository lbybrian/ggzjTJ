...
<script>
import Example1 from "../../../../static/example/lineChart/1.vue";
...
export default {
  ...
  data() {
    return {
      basicData: {},
      componentPath: "/static/example/lineChart/1.vue",
      exampleSelect: "",
      activeNames: "1",
      exampleCodeDialog: {
        visible: false,
        ...
        data: [
          {
            name: "itemStyle",
            description:
              "折线的样式和属性。请参考https://echarts.apache.org/zh/option.html#series-line",
            type: "Object",
            option: "-",
            default: "-",
          },
  ...
  methods: {
    ...
    exampleCallback1() {
      ...
      tData.itemStyle = {color : ["red", "yellow", "pink"];}
      tData.data = [
        {
          name: "周一",
          value: [3000, 200, 2],
